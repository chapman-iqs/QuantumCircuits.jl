...
md"""
In this interactive notebook, we focus on the second part -- the role of resonator states in qubit readout. In particular, we'll look at properties and dynamics of coherent states and how these couple to qubit states to facilitate measurement. This notebook is based largely on unpublished notes ($Dressel_notes_2019).
"""
...
TableOfContents(title="Resonator states")
