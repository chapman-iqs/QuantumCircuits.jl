module QuantumCircuits
	...
	const Timescale = Union{Float64, Int64}
	const Rate = Union{Float64, Int64}
	const Efficiency = Union{Float64, Int64}
	...
	fidelity(ρ::QOp, σ::QOp) = real(QuantumOpticsBase.fidelity(ρ, σ))
